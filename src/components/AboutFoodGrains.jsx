                    ...
                    <div className="col-md-6">
                        <div className="leftCard">
                            ...
                            <p>
                                ...
                                founded under the leadership of Mr. Vinay Kumar Singh. With advanced Japanese milling technology and an integrated production model, SSIPL serves both domestic and international markets with consistency and reliability.
                            </p>
                            {/* CTA Button */}
